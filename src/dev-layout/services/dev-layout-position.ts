/** https://github.com/wannabegeek/ng2-split-pane/blob/master/src/position.service.ts */
import { ElementRef } from '@angular/core';

export class DevLayoutPosition {
  /**
   * Provides read-only equivalent of jQuery's position function:
   * https://api.jquery.com/poisition/
   */
...
export const DEV_LAYOUT_POSITION_PROVIDER: any[] = [
  { provide: DevLayoutPosition, useClass: DevLayoutPosition }
];